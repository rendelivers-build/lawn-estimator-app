...
const _pages = [
  _TutorialPage(
    ...
    body: 'Type the property address and pick it from the list. '
  ...
  _TutorialPage(
    ...
    body: 'Snap a photo of the lawn — or the front of the house — so you and '
  ...
  _TutorialPage(
    ...
    body: 'Add labor and services like mowing, adjust prices, save the '
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: last ? _finish : () => _controller.nextPage(
